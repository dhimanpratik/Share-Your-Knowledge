...
.controller('SignInCtrl',['$rootScope','$scope','$firebaseObject','$firebaseAuth', function($rootScope,$scope,$firebaseObject,$firebaseAuth){
    console.log("Into");
    var ref = new Firebase("https://syk.firebaseio.com/");
  $scope.user = {emailid:"",pass:""};
    
    $scope.Connect = function(){
  var eid = $scope.user.emailid+"@xyz.com";
  var password = $scope.user.pass;
  $rootScope.nameis = $scope.user.emailid;
  ...
  email: $scope.user.emailid+"@xyz.com",
...
.controller('AddNewPost',['$rootScope','$scope','$firebaseObject',function($rootScope,$scope,$firebaseObject){
    ...
    $scope.AddNew = function()
    {
        ...
        ref.push({'username':$rootScope.nameis,
...
.controller('ChatController',['$ionicScrollDelegate','$scope','$rootScope','$firebaseObject',function($ionicScrollDelegate,$scope,$rootScope,$firebaseObject){
    console.log("Name : "+$rootScope.nameis);
...
var obj = $firebaseObject(ref);
  ...
  console.log("The read failed: " + errorObject.code);
    ...
    ref.push({'name':$rootScope.nameis,
            'reply':$scope.rep});
        var path = ref.toString();
        console.log(path);
        $ionicScrollDelegate.scrollBottom(true);
